"""
Adapted from (pretty much a copy right now): https://github.com/georgestein/ssl-legacysurvey/blob/main/scripts/similarity_search_nxn.py
...
def main(args):
    ...
    kwargs = {
        'n_cutouts': n_files*1000,
        'bands': ['u', 'g', 'r', 'i', 'z'],
        'cutout_size': input_size,
        'batch_size': batch_size, 
        'cutouts_per_file': 10000,
        'sampler': None,
        'normalize': norm_method,
        'h5_directory': f'{data_path}/'
    }
    
    DDL = dataloaders.SpencerHDF5ReaderDataset(**kwargs)
